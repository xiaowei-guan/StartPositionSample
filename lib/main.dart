...
class _DrmRemoteVideoState extends State<_DrmRemoteVideo> {
  ...
  Future<void> playFromBeginning() async {
    ...
    print('range start ${range.start.inSeconds} end ${range.end.inSeconds}');
    _controller = VideoPlayerController.network(
        'http://wp1-vxtoken-obc0304-hzn-ci.t1.lab.dyncdn.dmdsdp.com/dash/GO-AVC-DASH/NPO2_HD_CI/manifest.mpd',
        drmConfigs: DrmConfigs(
          type: DrmType.playready,
        ...
        formatHint: VideoFormat.dash,
        playerOptions: {
          'startPosition': range.start.inMilliseconds + 50 * 1000
        });
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          MaterialButton(
            child: Text('Play from beginning at 100 seconds'),
            onPressed: () {
              playFromBeginning();
            },
          ),
